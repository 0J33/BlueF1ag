...
#command helper
async def command_helper(input_list, comm):
    # REQUEST
    ...
    result = await asyncio.gather(asyncio.to_thread(command, ip, input_list, comm, datetime), asyncio.sleep(1))
    # SEND RESPONSE
    #await asyncio.sleep(1)
    #await delete(datetime)
